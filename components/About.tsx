...
export default function About({ className = '' }: AboutProps) {
  return (
    <section id="about" className={className}>
      <h2 className="text-5xl font-bold mb-6 text-sky-300 text-center md:text-left">ABOUT ME</h2>
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="text-gray-300 text-lg leading-relaxed space-y-4">
          ...
          <p>
            I have experience across a broad range of technologies including Python, TypeScript, C++, Go, and Assembly. I&apos;m proficient with frameworks and tools like Node.js,
